      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-24">
        ...
        <div className="flex flex-col w-[90vw] md:w-[60vw] items-center bg-gradient-to-t from-primary-200 to-gray-200 dark:to-gray-700 rounded-xl shadow-md">
          <div className='flex items-center gap-2 mt-4 flex-col md:flex-row'>
            <h2 className='font-bold'>Want to Add Product... ?</h2>
            <Link
              href='/addproduct' 
              className='flex gap-2 items-center text-lg bg-green-600 p-2 rounded'
            >
              <BsFillPlusCircleFill />CLICK HERE
            </Link>
          </div>
          <div className="relative flex items-center justify-center w-7/12 mx-2 mt-6 border-black border-t">
            <div className="absolute px-5 bg-transparent text-black"></div>
          </div>
