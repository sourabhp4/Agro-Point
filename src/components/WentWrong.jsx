        ...
        <section className="flex items-center h-full p-16 bg-gray-200 dark:bg-gray-900 dark:text-gray-100">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div className="max-w-md text-center">
                    ...
                    <p className="text-2xl font-semibold md:text-5xl">{ error }</p>
                    <p className="mt-4 mb-8 dark:text-gray-400">Please try again after some time, Remember to comeback...😇</p>
