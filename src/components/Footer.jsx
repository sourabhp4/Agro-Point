...
export default function Footer() {
  return (
    <footer>
      <div className="mt-8 flex flex-col items-center text-black dark:text-white">
        <div className="mb-3 flex space-x-4 text-xl">
        ...
        <div className="mb-2 flex flex-col sm:flex-row space-x-2 text-sm text-center">
