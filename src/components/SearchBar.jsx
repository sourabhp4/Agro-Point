...
const SearchBar = () => {
  return (
    <> 
        <Link href="/search" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-600 rounded-lg border border-blue-400 hover:bg-blue-500 hover:text-black
