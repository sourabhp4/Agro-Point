  ...
  return (
    <>
		<div className="flex justify-center items-center mt-4">
			<div className="container mx-auto bg-gradient-to-r from-primary-100 to-primary-200 rounded-lg p-4">
				<form onSubmit={(e) => handleSubmit(e)}>
					<h1 className="text-center font-bold mb-4 text-gray-700 dark:text-black text-2xl">What&apos;s in your mind ? </h1>
					...
					<div className="sm:flex items-center bg-white rounded-lg overflow-hidden px-2 py-2 justify-between">
						...
						<div className="rounded-lg space-x-4 mx-auto ">
							<button className="bg-yellow-600 text-gray-200 text-base rounded-lg px-4 py-2 font-thin">
