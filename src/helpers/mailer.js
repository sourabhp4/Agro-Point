...
export const sendEmail = async ({ email, emailType, userId }) => {
    try {
        ...
        <div class="spacer_block block-3" style="height:1px;line-height:1px;font-size:1px;"> </div>
        ...
        <p style="margin: 0;"><strong>❗IN CASE THIS IS NOT BY YOUR ACTIONS, PLEASE IGNORE...</strong><br/><strong>THANK YOU 🙂...</strong></p>
        </div>
        </td>
        </tr>
        </table>
